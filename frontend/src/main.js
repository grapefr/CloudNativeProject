...
pluralCaseList.push( {plural: "models/models", pascal: "ModelModel"} )

pluralCaseList.push( {plural: "notices/notices", pascal: "NoticeNotice"} )

pluralCaseList.push( {plural: "cores/cores", pascal: "CoreCore"} )

pluralCaseList.push( {plural: "targets/targets", pascal: "TargetTarget"} )
